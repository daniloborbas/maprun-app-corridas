...
begin
  ...
  insert into public.events(
    id, slug, name, short_description, description, description_source, feed_image_url, start_date, end_date,
    ...
    coalesce(nullif(payload->>'description_source',''),'unknown'), payload->>'feed_image_url', (payload->>'start_date')::timestamptz,
    ...
    description_source=excluded.description_source, feed_image_url=excluded.feed_image_url, slug=excluded.slug, start_date=excluded.start_date, end_date=excluded.end_date,
