...
export interface EvidenceFirstTelemetry { discoveryUrlsFound: number; evidenceDocsFetched: number; evidenceDocsUsed: number; evidenceCacheHits: number; evidenceCacheMisses: number; deterministicFieldsResolved: number; llmFieldsRequested: string[]; evidenceResolverCalled: boolean; fallbackWebSearchUsed: boolean; fallbackReasons: string[]; evidenceChars: number; evidenceResolverInputTokens: number; evidenceResolverOutputTokens: number; fallbackInputTokens: number; fallbackOutputTokens: number; inputTokens: number; outputTokens: number; totalTokens: number; }
