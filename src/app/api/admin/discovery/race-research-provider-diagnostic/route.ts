...
import { createRaceResearchProvider, getResearchModelConfiguration, ResearchProviderError } from '@/features/discovery/openai-research-provider';
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ success: false, candidateId: candidate.id, error: { phase: 'responses_api', message: 'Falha controlada na pesquisa web.' } }, { status: 200 });
  }
}
